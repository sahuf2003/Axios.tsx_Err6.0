...
const DocumentsPage = () => {
    return (
        <div className="max-w-7xl mx-auto p-6">
            <h1 className="text-3xl font-bold text-blue-600">Document Sharing</h1>
            ...
            <div className="mt-8">
                ...
                {/* Display uploaded documents (this can be dynamic depending on your backend or static for now) */}
                <div className="mt-4">
