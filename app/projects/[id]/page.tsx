        ...
        <div className="max-w-3xl mx-auto p-6">
            <Card className="p-6 border">
                <CardContent>
                    ...
                    <p className="font-semibold mt-4">Compensation: {project.price}</p>
                </CardContent>
            </Card>

            {/* Application Form */}
            <div className="mt-8">
                <h2 className="text-xl font-bold">Apply for this Project</h2>
                <form className="space-y-4 mt-4" onSubmit={handleSubmit}>
                    ...
                    <Input name="portfolio" placeholder="Portfolio Link (GitHub, Dribbble, etc.)" value={form.portfolio} onChange={handleChange} required />
                    <Textarea name="coverLetter" placeholder="Why are you a good fit?" value={form.coverLetter} onChange={handleChange} required />
                    <Button className="w-full bg-blue-600 hover:bg-blue-700" type="submit">Submit Application</Button>
                </form>
            </div>
        </div>
    );
